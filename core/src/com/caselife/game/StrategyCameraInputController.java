...
public class StrategyCameraInputController extends CameraInputController {
    ...
    private boolean moveBacwardKeyPressed;
    ...
    public void update()
    {
        if (strafeLeftKeyPressed || strafeRightKeyPressed || moveBacwardKeyPressed || moveForwardKeyPressed) {
